...
Players can normally leave an alliance, and alliance leadership can remove members when needed.
...
A player may normally leave an alliance from the alliance menu.
...
Alliance leadership may remove a member if that member is eligible to be removed under the current alliance rules.
...
If a player is still tied to active alliance troop actions, their leave or removal may be delayed until those actions finish or their troops are returned.
...
Alliance changes must never leave troops in an invalid, abandoned, or ownerless state.
...
* [📜 Alliance Rules and Restrictions](alliance-rules-and-restrictions.md)
