...
<figure><img src="../.gitbook/assets/fort (1).png" alt=""><figcaption></figcaption></figure>

An alliance may control only **one Fort at a time**.

## Forts and Bonuses

| Fort                | World Position | Alliance Bonus              |
| ------------------- | -------------- | --------------------------- |
| **Northwatch Fort** | (500, 750)     | 10% Troop Training Speed    |
| **Ironvale Fort**   | (750, 500)     | 10% Research Speed          |
